...
import { UserPlus, Trash2, ShieldCheck, Users, Lock } from 'lucide-react';
...
export default function Settings() {
  ...
  // Only call admin query if user is actually an admin — prevents Forbidden crash for staff
    ...
    <div className="space-y-12 animate-in fade-in duration-700 max-w-[1400px] mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-100 pb-10">
        <div>
          ...
          <p className="text-slate-500 font-medium">View your session details and facility security protocols.</p>
        </div>
      </div>

      <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
        {/* Profile / Session Info — visible to everyone */}
        ...
        {/* ADMIN PANEL — only rendered for super_admin */}
        {isAdmin ? (
                    ...
                    <div key={user._id} className="flex items-center justify-between p-5 hover:bg-slate-50/50 transition-colors">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-[9px] uppercase font-black text-primary tracking-widest mt-0.5">{user.role.replace('_', ' ')}</p>
                        </div>
                      </div>
          ...
          /* Staff view — friendly message, no crash */
          <div className="system-card bg-white p-10 shadow-premium border border-slate-50 flex flex-col items-center justify-center text-center gap-6 min-h-[300px]">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm font-medium max-w-xs">
                This section is restricted to administrators only. Please contact your admin to manage team accounts.
              </p>
            </div>
            <div className="bg-slate-50 border border-slate-100 rounded-2xl px-6 py-3 text-[10px] font-black text-slate-400 uppercase tracking-widest">
